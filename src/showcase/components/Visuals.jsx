  ...
  useEffect(()=>{
    ...
    const draw=()=>{
      ...
      if (isDusk) {
        ...
        ctx.fillStyle="rgba(15,23,42,0.015)"; ctx.fillRect(0,0,W,H);
      }
      if(project.id==="silverwall"){
        ...
        const lines=[
          ...
          { t: "Loading User: Pushan", c: isDusk ? "rgba(255,255,255,0.7)" : "rgba(15,23,42,0.7)" },
          { t: "Status: Level 42 [God Mode]", c: "#ffbd2e" },
          { t: "Streak: 15 Days (+20% XP)", c: "#ff5f57" },
          { t: "$ quest --status", c: "#9061F9" },
          { t: "> Daily: Execute 50 cmds (15/50)", c: isDusk ? "rgba(255,255,255,0.5)" : "rgba(15,23,42,0.5)" }
        ];
        const lineTime = 20;
