        ...
        <div className="space-y-6">
          {challenges.map((item, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <GlowCard className="flex gap-6 items-start p-6 rounded-2xl bg-white/10 border border-white/20 hover:bg-white/20 transition-colors duration-300 backdrop-blur-sm">
