  ...
  return (
    <section className="py-20 px-6">
      <div className="container max-w-2xl mx-auto">
        <motion.div 
          className="relative overflow-hidden rounded-3xl bg-white/30 backdrop-blur-xl border border-white/50 p-12 text-center shadow-[0_8px_32px_0_rgba(31,38,135,0.05)]"
